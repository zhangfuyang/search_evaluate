...
phase = 'valid'
per_edge_datapath = os.path.join(config['data_folder'], 'IP')
name = os.path.join(config['data_folder'], phase+'_list.txt')
with open(name, 'r') as f:
    namelist = f.read().splitlines()
gt_datapath = os.path.join(config['data_folder'], 'data/gt')

for file_name in namelist:
    gt_data = np.load(os.path.join(gt_datapath, file_name+'.npy'), allow_pickle=True).tolist()
    per_edge_data = np.load(os.path.join(per_edge_datapath, file_name+'.npy'), allow_pickle=True).tolist()
    ...
    conv_data = {'corners': per_edge_corners, 'edges': per_edge_edges}
